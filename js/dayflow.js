...
class CalTemplate
{
    static getDayOfWeek(date) {
      ...
      static calRow(date, items = []){
        ...
        bodydiv.id = '';
        bodydiv.classList.add('uk-child-width-1-4@xl','uk-child-width-1-3@l','uk-child-width-1-2@m','uk-child-width-1-2@s','uk-grid-small','uk-grid-match','start-collapse','section-padding','uk-grid','uk-grid-stack','cl-row-content');
